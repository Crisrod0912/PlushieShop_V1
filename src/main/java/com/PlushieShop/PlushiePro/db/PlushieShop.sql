CREATE DATABASE  IF NOT EXISTS `plushieShop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `plushieShop`;
-- MySQL dump 10.13  Distrib 8.0.44, for Win64 (x86_64)
--
-- Host: localhost    Database: plushieshop
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '2b9f1c4c-f49b-11f0-9172-18c04da8b6b8:1-171';
...
INSERT INTO `usuario` VALUES (1,'Laura','Pérez','laura@example.com','Heredia Centro','laura_perez','$2a$12$04CrX/liDFv9De2pwewjH.V54GWW.4aa/LrZJwetwXn5otlGFPv7.','1111-1111','1234','2030-04-15',2),(2,'Maru','García','maria@example.com','Llanos del Sol','maru_garcia','$2a$12$Iaz69g9rD9tzKO0kaB.V/.UkwIRHMPr9nPU1kCM7jc.9.wkRrx7Yi','2222-2222','5678','2028-04-15',2),(3,'Carlota','López','carlos@example.com','Calle Sánchez','carl_lopez','$2a$12$stCHKC9z1UJs3rDa2kisfucZnHTXruTuNJwsOILv5bzLOMdc9cRkG','3333-3333','9101','2029-04-15',2),(4,'Admin','Admin','admin@example.com','La Aurora','admin','$2a$12$mwkEba3Ge19v4g1dIN3pmuT2oDVyd51NWDHpquHq4wdVeesbcVBBC','4444-4444','1314','2032-04-15',1);
...
-- Dump completed on 2026-02-05 21:01:35
