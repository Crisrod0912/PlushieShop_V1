...
CREATE TABLE plushieShop.producto (
  ...
  FOREIGN KEY fk_producto_caregoria (id_categoria) REFERENCES plushieShop.categoria(id_categoria)
);

CREATE TABLE plushieShop.roles (
...
CREATE TABLE plushieShop.usuario (
  ...
  KEY id_rol (id_rol),
  CONSTRAINT usuario_ibfk_1 FOREIGN KEY (id_rol) REFERENCES plushieShop.roles (id)
);

CREATE TABLE plushieShop.factura (
  ...
  FOREIGN KEY fk_factura_usuario (id_usuario) REFERENCES plushieShop.usuario(id_usuario)  
);

CREATE TABLE plushieShop.venta (
  ...
  FOREIGN KEY fk_ventas_factura (id_factura) REFERENCES plushieShop.factura(id_factura),
  FOREIGN KEY fk_ventas_producto (id_producto) REFERENCES plushieShop.producto(id_producto) 
);

INSERT INTO plushieShop.categoria (id_categoria, nombre, tipo, activo) VALUES
('1', 'Naruto', 'Anime', true),
...
INSERT INTO plushieShop.producto (id_producto, id_categoria, nombre, descripcion, precio, existencias, ruta_imagen, activo) VALUES
...
INSERT INTO plushieShop.roles VALUES 
(1, 'ROLE_ADMIN'),
(2, 'ROLE_USER');

INSERT INTO plushieShop.usuario VALUES
(1, 'Laura', 'Pérez', 'laura@example.com', 'Heredia Centro', 'laura_perez', '$2a$12$04CrX/liDFv9De2pwewjH.V54GWW.4aa/LrZJwetwXn5otlGFPv7.', '1111-1111', '1234', '2030-04-15', 2), /*secretpassword*/
...
INSERT INTO plushieShop.factura (id_factura, id_usuario, fecha, total, estado) VALUES
...
INSERT INTO plushieShop.venta (id_venta, id_factura, id_producto, precio, cantidad) VALUES
(1, 1, 5, 45000, 3),
(2, 1, 9, 15780, 2),
(3, 1, 10, 15000, 3),
(4, 2, 5, 45000, 1),
